...
@Component({
  selector: 'app-processboard',
  templateUrl: './processboard.component.html',
  styleUrls: ['./processboard.component.scss']
})
...
export class ProcessboardComponent implements OnInit {
  ...
  public radarChartData: ChartDataSets[] = [
    { data: [65, 59, 90, 81, 56, 55, 40], label: 'Budget' },
    { data: [28, 48, 40, 19, 96, 27, 100], label: 'Expenses' }
  ];
  ...
  public barChartData: ChartDataSets[] = [
    { data: [65, 59, 80, 81, 56, 55, 40], label: 'Back Process' },
    { data: [28, 48, 40, 19, 86, 27, 90], label: 'Process' },
    { data: [45, 20, 45, 95, 65, 65, 21], label: 'Front Process' }
  ];
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
